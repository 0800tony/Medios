...
| `GET` | `/api/projects/{id}/creative-plans` | Consultar el plan editable de piezas, medios y fases de la plataforma elegida |
| `PATCH` | `/api/projects/{id}/creative-plans/{plan_id}` | Corregir o aprobar el plan de campaña antes de producción |
