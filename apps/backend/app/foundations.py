...
CREATIVE_REFERENCE_LENSES = [
    ...
    {"group": "Dirección de arte rioplatense", "names": "Matías Lafalla, Joaquín Cubría, Ignacio Ferioli, Anita Ríos, Rafael Santamarina, Rafa El Ceggio, Melanie Tobal, Javier Mentasti, Pipe Stein, Ignacio González, Marcelo Pereira, Marcelo García, Carlos Palleiro, Fernando Álvarez Cozzi, Horacio Añón, Gustavo Wojciechowski, Mingo Ferreira y Fidel Sclavo", "lens": "concepto antes que decoración, composición precisa, tipografía y fotografía con oficio, cultura local sin folklore, sobriedad, contraste y una imagen que sostiene la idea"},
]
