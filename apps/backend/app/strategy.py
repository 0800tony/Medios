...
def local_dossier(project:Project,brief:dict[str,str],source_names:list[str])->dict[str,object]:
    ...
    routes=[
        ...
        {"nombre":"Hacer visible una prueba superior","hipotesis":"Convertir una ventaja comprobable de producto u origen en preferencia.","condicion_para_elegirla":"Resolver Prueba competitiva y de producto."},
        {"nombre":"Remover la fricción comercial","hipotesis":"Alinear propuesta, precio, distribución y comunicación para facilitar la elección.","condicion_para_elegirla":"Validar valor percibido y capacidad de distribución."},
    ]
    ...
    base.update({
        ...
        "que_no_sabemos":gaps,
        "diagnostico_del_problema":{"hallazgo_preliminar":"El desafío parece ser construir una propuesta elegible y escalable, no solamente lanzar una marca.","hipotesis_a_refutar":"Si la gente conoce la nueva marca, la comprará al precio y en el canal propuestos.","por_que_no_es_conclusion":f"Falta resolver: {', '.join(top_names)}."},
        ...
        "comparacion_de_rutas":{"ruta_1":"Prioriza relevancia humana.","ruta_2":"Prioriza superioridad demostrable.","ruta_3":"Prioriza disponibilidad y reducción de fricción.","decision_pendiente":"No elegir hasta resolver los vacíos que condicionan cada ruta."},
