...
export type StrategyDecision={id:string;project_id:string;dossier_id:string;route_key:string;rationale:string;launch_plan:string;created_at:string;updated_at:string};
