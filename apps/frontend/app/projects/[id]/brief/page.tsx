...
const groups = [
  ...
  { title: "Ejes de comunicación OLIVA", fields: [["communication_axes", "Ejes prioritarios para este caso", "Indicá los ejes que el cliente espera trabajar: reposicionamiento, stakeholders, prescriptores, medios, liderazgo, públicos prioritarios, crisis, implicación de personas, redes, financiera, proyecto, interna o sistemas de información."], ["stakeholders_map", "Stakeholders y prescriptores", "Quiénes pueden habilitar, condicionar, recomendar o cuestionar el proyecto."], ["reputation_crisis_context", "Reputación, crisis y relacionamiento", "Riesgos, temas sensibles, voceros, medios o conversaciones que conviene considerar."], ["internal_information_context", "Comunicación interna y sistemas de información", "Equipos involucrados, información que falta, canales internos, reportes y responsables."]] },
